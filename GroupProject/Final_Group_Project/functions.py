...
subnet_guess_df = pd.DataFrame(columns=["Question", "Correct Answer",
                                        "User Answer", "Result"])
decimal_guess_df = pd.DataFrame(columns=["Random Binary", "Correct Decimal",
                                         "Result"])
binary_guess_df = pd.DataFrame(columns=["Random Decimal", "Correct Binary",
                                        "Result"])
